...
def verify():
  userID = request.headers.get('Authorization')
  oauth = spotipy.oauth2.SpotifyOAuth(client_id=CLI_ID, client_secret=CLI_SECRET, redirect_uri=REDIR_URI, cache_path=(EFS_PATH + str(userID)), scope=SCOPE, show_dialog=SHOW_DIALOG)
